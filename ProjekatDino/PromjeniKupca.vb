Public Class PromjeniKupca
    Private kupci As List(Of Kupac)
    Private i As Integer
    Public Sub New(ByRef kupci As List(Of Kupac), ByVal i As Integer)
        InitializeComponent()
        Me.kupci = kupci
        Me.i = i
        tbxSifra.Text = kupci(i).sifra.ToString()
        tbxIme.Text = kupci(i).ime
        tbxPrezime.Text = kupci(i).prezime
        tbxAdresa.Text = kupci(i).adresa
        tbxMjesto.Text = kupci(i).mjesto
        tbxMaticniBroj.Text = kupci(i).maticniBroj
        tbxPostanskiBroj.Text = kupci(i).postanskiBroj.ToString()
    End Sub
